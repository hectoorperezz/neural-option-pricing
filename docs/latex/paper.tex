...
\bottomrule
\end{tabular}
\caption{Los once surrogates del trabajo. Todos los comparados dentro de un mismo experimento comparten arquitectura, optimizador, hiperparámetros y semilla.}
