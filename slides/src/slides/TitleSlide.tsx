...
export function TitleSlide() {
  return (
    ...
    >
      ...
      <NeuralNetDiagram className="absolute right-[3%] top-[28%] z-0 h-[38%] w-[42%]" />
      ...
      <div className="relative z-10 flex h-full flex-col px-[8%] pt-[4%] pb-[5%]">
        ...
        <div className="mt-[4%] flex-1">
          <motion.h1
            ...
            className="font-display text-[clamp(2.4rem,5.6vw,5.2rem)] font-medium leading-[1.04] tracking-tight text-[var(--color-uni-black)]"
          >
